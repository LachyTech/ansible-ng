...
class ServicesSnmpAlertManagers(CollectionConfigBase):
    """
    Manages SNMP Alert Manager configuration on Opengear devices.

    Each record is identified by the (address, port, protocol) tuple, mirroring
    the multi_field_identifier used by ogcli.
    """
