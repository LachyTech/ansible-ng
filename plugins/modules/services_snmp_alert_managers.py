...
description:
  - Manages the collection of SNMP Alert Managers (SNMP TRAP/INFORM destinations)
    an Opengear device sends SNMP alerts to.
  - Each record's identity is its C(name).
...
options:
  config:
    ...
    suboptions:
      ...
      name:
        type: str
        description: A description used to identify the SNMP Alert Manager.
        required: true
      protocol:
        type: str
